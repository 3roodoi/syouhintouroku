          ...
          <div class="card-body">
            <form action="{{ route('register.custom') }}" method="POST">
              ...
              <div class="form-group mb-3">
                <input type="text" placeholder="名前" id="name" class="form-control" name="name" required autofocus>
                @if ($errors->has('name'))
              ...
              <div class="form-group mb-3">
                <input type="text" placeholder="メールアドレス" id="email_address" class="form-control" name="email" required
                  autofocus>
                @if ($errors->has('email'))
